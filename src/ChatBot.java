...
public class ChatBot {
    ...
    // method that reminds your birth month.
    public void Bday(String month) {
        System.out.println("In case you were wondering, your birthday is " + month);
    }
...
// method that converts feet to inches and returns the inches
    public int convertFeetToInches(int numFeet2) {
            final int INCHES_PER_FOOT = 12;
            return INCHES_PER_FOOT * numFeet2;
}
